...
namespace MyShop.DataAccess.InMemory
{
    public class ProductCategoryRepository
    {
        ...
        // initializing the 'productsCategories' with cache named 'productsCategories' as list
        ...
        public IQueryable<ProductCategory> Collection()
        {
            ...
            // returning a queryable, list of ProductCategory model. List<ProductCategory> productsCategories
        }
